...
export default function InstructorToolbar({
  ...
  return (
    <>
      ...
      {showCheckpoint && courseCheckpointConfig && (
        <CheckpointBar
          checkpoint={{
            revealed:
              syncCheckpoint?.revealed ?? courseCheckpointConfig.revealed,
            revealDate:
              syncCheckpoint?.revealDate ?? courseCheckpointConfig.revealDate,
