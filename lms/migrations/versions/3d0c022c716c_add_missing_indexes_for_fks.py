...
def downgrade() -> None:
    op.drop_index(
        op.f("ix__grouping_membership_user_id"), table_name="grouping_membership"
    )
    op.drop_index(
        op.f("ix__assignment_membership_assignment_id"),
    ...
    op.drop_index(
        op.f("ix__assignment_grouping_grouping_id"), table_name="assignment_grouping"
    )
    op.drop_index(
        op.f("ix__assignment_grouping_assignment_id"), table_name="assignment_grouping"
    )
