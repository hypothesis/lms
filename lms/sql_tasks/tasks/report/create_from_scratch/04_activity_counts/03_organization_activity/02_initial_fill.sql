...
DROP INDEX IF EXISTS report.organization_activity_calendar_date_idx;
...
CREATE INDEX organization_activity_calendar_date_idx ON report.organization_activity (calendar_date);
