def includeme(config):
    ...
    config.add_route(
        "blackboard_oauth_callback", "/blackboard_oauth_callback",
    )
    config.add_route(
        "blackboard_api.authorize", "/api/blackboard/authorize",
    )
    config.add_route(
        "blackboard_api.courses.files.list", "/api/blackboard/courses/{course_id}/files"
    )
    config.add_route(
        "blackboard_api.files.via_url", "/api/blackboard/files/{file_id}/via_url"
    )
