# Sample book and chapter data for VitalSource books.
#
# The data here is extracted from the VitalSource Products API.
#
...
toc_data = {
    "BOOKSHELF-TUTORIAL": [
        ...
        {
            "title": "Video Demonstration: Downloading the Bookshelf Desktop Application",
