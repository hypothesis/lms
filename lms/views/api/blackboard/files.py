...
class BlackboardFilesAPIViews:
    ...
    def via_url(self):
        ...
        try:
            ...
            public_url = self.blackboard_api_client.public_url(course_id, found_file_id)

            # Store a mapping so we don't have to re-search next time.
            print("MAPPING", course, file_id, found_file_id)
            self.course_copy_plugin.set_mapped_file_id(course, file_id, found_file_id)
