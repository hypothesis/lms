...
class DeepLinkingFieldsViews:
    ...
    def file_picker_to_form_fields_v13(self):
        ...
        assignment_params = self._get_assignment_params(self.request)
    ...
    @staticmethod
    def _get_assignment_params(request) -> dict:
        """
        Translate content information from the frontend to a dict with the assignment configuration.
        """
