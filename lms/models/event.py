...
class Event(BASE):
    ...
    type_id = sa.Column(
        sa.Integer(), sa.ForeignKey("event_type.id", ondelete="cascade")
    )
    ...
    assignment_id = sa.Column(
        sa.Integer(), sa.ForeignKey("assignment.id", ondelete="cascade"), nullable=True
    )
...
class EventUser(BASE):
    ...
    lti_role_id = sa.Column(
        sa.Integer(), sa.ForeignKey("lti_role.id", ondelete="cascade"), nullable=True
    )
