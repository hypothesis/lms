...
class TestUpsertLISResultSourcedId:
    def test_it_returns_when_validation_fails(
        ...
        lis_result_sourcedid_info.side_effect = ValidationError("foo")
    ...
    def test_it_raises_if_validation_raises_other_than_ValidationError(
        ...
        lis_result_sourcedid_info.side_effect = OSError()
    ...
    def test_it_upserts_lis_result_sourcedid(
        self, pyramid_request, context, lis_result_sourcedid_svc, return_value,
    ):
    ...
    def lis_result_sourcedid_info(self, patch, return_value):
        LISResultSourcedIdSchema = patch(
            "lms.views.basic_lti_launch.LISResultSourcedIdSchema"
        )
        ...
        return LISResultSourcedIdSchema.return_value.lis_result_sourcedid_info
