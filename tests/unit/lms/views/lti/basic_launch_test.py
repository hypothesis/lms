...
class ConfiguredLaunchBaseClass:
    ...
    def LTIHypothesisBridge(self, patch):
        return patch("lms.views.lti.basic_launch.LTIHypothesisBridge")

    @pytest.fixture(autouse=True)
    def frontend_app(self, patch):
        return patch("lms.views.lti.basic_launch.frontend_app")

    @pytest.fixture(autouse=True)
    def ModuleItemConfiguration(self, patch):
        return patch("lms.views.lti.basic_launch.ModuleItemConfiguration")
