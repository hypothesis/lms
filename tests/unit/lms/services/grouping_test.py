...
class TestGetAuthorityProvidedID:
    def test_generating_an_authority_provided_id_for_a_course(
        self, get_authority_provided_id
    ):
        assert (
            get_authority_provided_id(parent=None, type_=Grouping.Type.COURSE)
    ...
    def test_it_raises_if_a_child_grouping_has_no_parent(
        self, get_authority_provided_id, type_
    ):
        with pytest.raises(
            AssertionError, match="Non-course groupings must have a parent"
        ):
            get_authority_provided_id(parent=None, type_=type_)
    ...
    def test_generating_an_authority_provided_id_for_a_child_grouping(
        self, get_authority_provided_id, type_, expected
    ):
        assert (
            get_authority_provided_id(
    ...
    @pytest.fixture
    def get_authority_provided_id(self, svc):
        return partial(svc.get_authority_provided_id, "t_c_i_guid", "lms_id")
