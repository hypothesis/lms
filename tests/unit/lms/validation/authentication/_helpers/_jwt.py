...
from lms.validation.authentication._helpers import jwt_encoding
...
class TestDecodeJWT:
    def test_it_returns_the_decoded_payload(self):
        ...
        decoded_payload = jwt_encoding.decode_jwt(jwt_str, "test_secret")
    ...
    def test_it_raises_if_the_jwt_is_encoded_with_the_wrong_secret(self):
        ...
        with pytest.raises(jwt_encoding.InvalidJWTError):
            jwt_encoding.decode_jwt(jwt_str, "test_secret")
    ...
    def test_it_raises_if_the_jwt_has_expired(self):
        ...
        with pytest.raises(jwt_encoding.ExpiredJWTError):
            jwt_encoding.decode_jwt(jwt_str, "test_secret")
    ...
    def test_it_can_decode_a_jwt_from_encode_jwt(self):
        original_payload = {"TEST_KEY": "TEST_VALUE"}
        jwt_str = jwt_encoding.encode_jwt(original_payload, "test_secret")
...
class TestEncodeJWT:
    ...
    def test_it_returns_a_string_not_bytes(self):
        jwt_str = jwt_encoding.encode_jwt({"TEST_KEY": "TEST_VALUE"}, "test_secret")
